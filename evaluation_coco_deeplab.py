...
def applyDNN(oriImg, images, sym1, arg_params1, aux_params1,cmodel):
    ...
    print("testshape",testimage.shape)
    onedata = mx.io.DataBatch([mx.nd.array([testimage[:,:,:]])], None)
    #print 'batch'
    cmodel.forward(onedata,is_train=False)
    #print 'forward'
...
def applyModel(oriImg, param, sym, arg_params, aux_params):
    ...
    for i in range(len(multiplier)):
        ...
        try:
            ...
            heatmap, pagmap = applyDNN(oriImg, imageToTest, sym, arg_params, aux_params,cmodel)
            # print(heatmap.shape)
            # print(pagmap.shape)
...
# sym, _, _ = mx.model.load_checkpoint('../model/vggppose', 10500)
